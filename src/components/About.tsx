      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 text-mist-400 leading-relaxed">
            <p>
              Halo! Saya <span className="text-green-700 font-semibold">Muhammad Fajar Kurniawan</span>,
              siswa SMK kelas 11 jurusan RPL yang passionate di dunia
              backend development.
            </p>
            <p>
              Saya sudah terbiasa bekerja dengan <span className="text-white">NestJS</span>,{' '}
              <span className="text-white">TypeScript</span>, dan <span className="text-white">MySQL</span>.
              Sekarang saya sedang memperluas skill ke dunia fullstack dengan belajar Next.js.
            </p>
            <p>
          ...
          <div className="bg-mist-900/50 border border-mist-800 rounded-2xl p-6 space-y-4">
            {[
              ...
              <div key={item.label} className="flex gap-5">
                <span className="text-green-700 font-medium w-24 shrink-0">{item.label}</span>
